...
export default function WatchMovie() {
  ...
  const prepareMovie = async (retryCount = 0): Promise<boolean> => {
    ...
    const url = `https://34.10.139.168.nip.io/verpeli/movie/${encodeURIComponent(slug)}/prepare`;
  ...
  const connectWebSocket = () => {
    ...
    const wsUrl = `wss://34.10.139.168.nip.io/verpeli/movie/ws/watch/${encodeURIComponent(slug)}`;
