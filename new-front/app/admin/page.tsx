...
const API_BASE = "http://34.135.146.173.nip.io/usuarios/users";
...
export default function AdminPanel() {
  ...
  const loadUsers = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://34.135.146.173.nip.io/usuarios/users/list?${params.toString()}`, {
        headers: {
  ...
  const loadCounters = async () => {
    try {
      ...
      console.log("URL:", `http://34.135.146.173.nip.io/usuarios/users/counters`);
      
      const response = await fetch(`http://34.135.146.173.nip.io/usuarios/users/counters`, {
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json"
        }
  ...
  const loadUserDetail = async (userId: number) => {
    try {
      const response = await fetch(`http://34.135.146.173.nip.io/usuarios/users/${userId}/detail`, {
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json"
        }
  ...
  const updateUserField = async (userId: number, field: string, value: boolean) => {
    ...
    try {
      const response = await fetch(`http://34.135.146.173.nip.io/usuarios/users/${userId}/${field}`, {
        method: "PUT",
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json"
